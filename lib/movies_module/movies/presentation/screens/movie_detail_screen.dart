...
import 'package:clean_arch_ug/movies_module/movies/presentation/screens/dummy%20(1).dart';
...
class MovieDetailContent extends StatelessWidget {
            ...
            background: FadeIn(
              ...
              child: ShaderMask(
                ...
                child: CachedNetworkImage(
                  ...
                  imageUrl: MovieAppConstants.imageUrl(movie.backdropPath),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8.0),
                  Text(
                    'Genres: ${_showGenres(movie.generes)}',
                    style: const TextStyle(
                      color: Colors.white70,
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
  ...
  String _showGenres(List<GeneresEntity> genres) {
    String result = '';
        ...
        (context, index) {
          ...
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: MovieAppConstants.imageUrl(recommendation.backdropPath),
